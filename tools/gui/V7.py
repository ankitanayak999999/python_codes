...
def get_user_inputs(fields=None, controller_field=None, dynamic_field_map=None):
    ...
    # NEW: placeholder that a radio can populate (file or dir)
    ...
    def build_fields(field_list, start_row=0, key_prefix="static"):
        ...
        for i, field in enumerate(field_list):
            ...
            if ftype == "file":
                widgets.extend(render_file_input(row, label_text, required, key_prefix, filetypes=field.get("filetypes")))
            elif ftype == "dir":
                ...
                if ftype == "text":
                    ...
                    # NEW: optional radio -> slot control
                    ...
                    if ctrl:
                        ...
                        def _populate_slot(selection):
                            ...
                            # if slot already populated with an Entry, use its parent frame
