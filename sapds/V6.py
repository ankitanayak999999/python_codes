...
def parse_single_xml(xml_path: str) -> pd.DataFrame:
    ...
    for e in root.iter():
        ...
        # -------- lookup_ext via FUNCTION_CALL (authoritative) --------
        ...
        # -------- generic fallback (lookup & lookup_ext) --------
    ...
    # strict dedupe by normalized identity; merge positions
    def nkey(r):
